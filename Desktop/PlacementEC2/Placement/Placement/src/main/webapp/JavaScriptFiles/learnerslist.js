...
fetch(`http://${port}/Placement/services/placement/display`)
...
function searchStudent() {
  ...
  studentItems.forEach(item => {
    const name = item.querySelector('.col6').textContent.toLowerCase();
    const rollNo = item.querySelector('.col7').textContent.toLowerCase();
    const email = item.querySelector('.col8').textContent.toLowerCase();
